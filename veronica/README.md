...
Para poder inspirarme en el desarrollo de mi propuesta, tomé como ejemplo tres plataformas que existen en el mercado actualmente y están relacionados a la problemática.
...
Teniendo en cuenta mis referentes iniciales, mi propuesta adopta una estructura clara de rúbrica (Peergrade), también adopta el cálculo automatizado por fases (Moodle), y conserva la simplicidad de uso (Google Forms).

Basándome en las entrevistas a docentes, me di cuenta que existe una necesidad de evaluación individual justa, se requiere de una reducción de carga administrativa, se necesita transparencia y anonimato, es importante la automatización de cálculos, y además, existe un gran interés en herramientas analíticas para detectar problemas en grupos.
...
Mi propuesta no solo cumple con los requerimientos funcionales establecidos, sino que incorpora herramientas analíticas e inteligentes que fortalecen la evaluación formativa.
